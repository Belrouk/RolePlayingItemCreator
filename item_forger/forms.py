...
class ViewCollectionForm(Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["rarity_filter"] = ChoiceField(choices=RPItem.RARITY_LEVEL, required=False)
        self.fields["attunement_filter"] = ChoiceField(choices=RPItem.ATTUNEMENT, required=False)
        self.fields["type_filter"] = ChoiceField(choices=RPItem.ITEM_TYPE, required=False)

    def _get_campaign_list(self):
        campaign_choices = RPItem.objects.order_by().values_list('campaign', flat=True).distinct()
